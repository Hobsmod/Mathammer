...
hero_hash['Iron Hands Biker Captain - TH/SS'] = Unit2.new()
hero_hash['Iron Hands Biker Captain - TH/SS'].addModels(space_marine_codex, sm_wep, 'Captain on Bike', 1, ['Thunder Hammer','Storm Shield'],['Master-crafted Boltgun','Chainsword'] )
hero_hash['Iron Hands Biker Captain - TH - Shield Eternal'] = Unit2.new()
hero_hash['Iron Hands Biker Captain - TH - Shield Eternal'].addModels(space_marine_codex, sm_wep, 'Captain on Bike', 1, ['Thunder Hammer','The Shield Eternal'],['Master-crafted Boltgun','Chainsword'] )
hero_hash['Iron Hands Biker Captain - The Fist of Vengance - Storm Shield'] = Unit2.new()
hero_hash['Iron Hands Biker Captain - The Fist of Vengance - Storm Shield'].addModels(space_marine_codex, sm_wep, 'Captain on Bike', 1, ['Thunder Hammer','The Fist of Vengance'],['Master-crafted Boltgun','Chainsword'] )
### Add Iron Hands warlord trait
hero_hash['Iron Hands Biker Captain - TH/SS'].getModels[0].addBaseRule('FNP - 6','Rend - Fight - Extra Attack')
hero_hash['Iron Hands Biker Captain - TH - Shield Eternal'].getModels[0].addBaseRule('FNP - 6','Rend - Fight - Extra Attack')
hero_hash['Iron Hands Biker Captain - The Fist of Vengance - Storm Shield'].getModels[0].addBaseRule('FNP - 6','Rend - Fight - Extra Attack')
...
hero_hash['Vulkan Hestan'].getModels[0].addRule(['Reroll - All - All - Single'])
hero_hash['Vulkan Hestan'].modBaseStat('S','1')
