...
hero_hash['Biker Captain - TH/SS'] = Unit2.new()
hero_hash['Biker Captain - TH/SS'].addModels(space_marine_codex, sm_wep, 'Captain on Bike', 1, ['Thunder Hammer','Storm Shield'],['Master-crafted Boltgun','Chainsword'] )
hero_hash['Biker Captain - TH - Shield Eternal'] = Unit2.new()
hero_hash['Biker Captain - TH - Shield Eternal'].addModels(space_marine_codex, sm_wep, 'Captain on Bike', 1, ['Thunder Hammer','The Shield Eternal'],['Master-crafted Boltgun','Chainsword'] )
hero_hash['Biker Captain - The Fist of Vengance - Storm Shield'] = Unit2.new()
hero_hash['Biker Captain - The Fist of Vengance - Storm Shield'].addModels(space_marine_codex, sm_wep, 'Captain on Bike', 1, ['Thunder Hammer','The Fist of Vengance'],['Master-crafted Boltgun','Chainsword'] )
