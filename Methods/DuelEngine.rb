...
###each of these is a unit
	...
	(1..iterations).each do
		...
		(1..rounds).each do |round|
			...
			if charger.hasRule('Healing Balms - D3') && round.odd? == true && round > 1
				healed = RollDice('D3')
			...
			if defender.hasRule('Healing Balms - D3') && round.even? == true && round > 1
				healed = RollDice('D3')
			...
			## If defender fights first they go here!
